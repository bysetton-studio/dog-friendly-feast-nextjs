...
export default function AddSticker() {
  return (
    <Link
      href="/add"
      className="absolute top-0 right-0 z-100 w-32 h-32 flex items-center justify-center no-underline transition-transform duration-250 ease-in-out hover:scale-[1.15] max-md:fixed max-md:top-auto max-md:left-auto max-md:bottom-5 max-md:right-5 max-md:w-27.5 max-md:h-27.5"
    >
